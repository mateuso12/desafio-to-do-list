  ...
  return (
    <div className="flex flex-row items-start pr-1 pb-1 md:pr-4 md:pb-4 bg-gray-600 rounded-md border border-yellow-400 ">
      <div className="flex mt-2 ml-2 md:mt-4 md:ml-4 ">
        <input type="checkbox" onChange={handleChecked} className="w-4 h-4 mt-1 peer text-green-600 rounded-full outline focus:outline-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
